...
//         setError('');
//         setModalIsOpen(false); // Close the modal on successful addition
//       } else {
...
//         setSelectedApplicantId('');
//         setError('');
//         setModalIsOpen(false); // Close the modal on successful edit
//       } else {
...
//       <hr />
//       <button onClick={() => setModalIsOpen(true)} disabled={loading}>
//         Add Premium
//       </button>
...
//                       disabled={loading}
//                       style={{ color: 'red', fontSize: '30px', marginLeft: '27px' }}
//                     />
//                   </td>
//                 </tr>
//               ))}
...
//         contentLabel="Add/Edit Premium"
//         className="modal"
//         overlayClassName="modal-overlay"
//       >
//         <h2>{selectedPremium ? 'Edit Premium' : 'Add Premium'}</h2>
...
//           <button
//             type="button"
//             onClick={selectedPremium ? handleSaveEdit : handleCalculatePremium}
//             disabled={loading}
//           >
//             {loading ? 'Processing...' : selectedPremium ? 'Save Edit' : 'Add Premium'}
//           </button>
//           <button
//             type="button"
...
import React, { useEffect, useState } from 'react';
import axios from 'axios';
import '../styles/PremiumManagement.css'; // We'll update this CSS file
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
